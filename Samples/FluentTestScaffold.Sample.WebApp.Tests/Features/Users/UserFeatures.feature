...
Scenario: When the user has logged in, then the system should respond with the logged in user's details
	...
	When the user's details are requested
	Then the system responds with the matching user's detailsScenario: When an invalid password is used, then the system should not return any information about the user
